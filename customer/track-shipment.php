...
/**
 * Track Shipment Page
 * Track orders by tracking number or order number
 */
...
if ($tracking_id) {
    ...
    $order = $order_model->findByTrackingOrOrder($tracking_id);
    
    if (!$order) {
        $error_message = 'No shipment found with that tracking number or order number.';
    } else {
        // Security check: customers can only track their own orders
        // Admin and employees can track any order for support purposes
        if ($user['role'] === 'customer' && $order['user_id'] != $user['id']) {
            $error_message = 'You are not authorized to track this shipment.';
            $order = null;
        } else {
    ...
    <div class="tracking-content">
        ...
        <?php if ($order): ?>
            ...
            <div class="tracking-results">
                ...
                <div class="tracking-actions">
                    <a href="view-order.php?id=<?php echo $order['id']; ?>" class="btn btn-primary">
        ...
        <?php elseif (empty($tracking_id)): ?>
            ...
            <div class="tracking-welcome">
                ...
                <p>Enter your tracking number or order number above to see real-time updates on your shipment's journey.</p>
